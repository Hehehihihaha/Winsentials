    ...
    pub fn new() -> Self {
        Self {
            meta: TweakMeta {
                ...
                name: "appearance.tweaks.openExplorerToThisPc.name".into(),
                short_description: "appearance.tweaks.openExplorerToThisPc.shortDescription".into(),
                detail_description: "appearance.tweaks.openExplorerToThisPc.detailDescription"
                    .into(),
